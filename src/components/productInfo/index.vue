          ...
          <el-tab-pane label="基本信息" name="0">
            <div class="detailSection divBox">
              ...
              <div class="list" style="display: block">
                ...
                <div v-show="formValidate.couponList && formValidate.couponList.length" class="item">
                  <div class="acea-row row-middle">
            ...
            <div class="detailSection divBox">
              ...
              <div style="margin-top: 16px">
                ...
                <template v-if="formValidate.specType === false">
                  <el-table :data="OneattrValue" class="tabNumWidth" size="small">
...
import { getListName } from '@/utils/ZBKJIutil';
