...
const operationRouter = {
  ...
  children: [
    ...
    {
      path: 'credit-rate-config',
      component: () => import('@/views/systemSetting/setting/index'),
      name: 'CreditRateConfig',
      meta: {
        title: '授信利率配置',
        icon: 'tree',
        noCache: false,
        formId: 67 // 授信利率配置表单模版ID
      },
    },
    {
      path: 'agreement',
    ...
    },
    {
      path: 'dictManagement',
      name: 'DictManagement',
      component: () => import('@/views/systemSetting/dictManagement'),
      meta: {
        title: '字典管理',
        icon: 'dictionary',
        roles: ['admin'],
      ...
      children: [
        {
          path: 'dictType',
          component: () => import('@/views/systemSetting/dictManagement/dictType'),
          name: 'DictType',
          meta: { title: '字典类型', icon: 'list' },
        },
        {
          path: 'dictData/:dictType?',
          component: () => import('@/views/systemSetting/dictManagement/dictData'),
          name: 'DictData',
          meta: { title: '字典数据', icon: 'table', activeMenu: '/operation/dictManagement/dictType' },
        },
      ],
    },
    {
      path: 'orgManagement',
      name: 'OrgManagement',
      component: () => import('@/views/systemSetting/orgManagement'),
      meta: {
        title: '机构管理',
        icon: 'tree',
        roles: ['admin'],
      ...
      children: [
        {
          path: 'orgCategory',
          component: () => import('@/views/systemSetting/orgManagement/orgCategory'),
          name: 'OrgCategory',
          meta: { title: '机构分类', icon: 'tree-table' },
        },
        {
          path: 'farmInstitution',
          component: () => import('@/views/systemSetting/orgManagement/farmInstitution'),
          name: 'FarmInstitution',
          meta: { title: '养殖机构', icon: 'component' },
        },
      ],
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            {
              path: 'download',
              component: () => import('@/views/application/routine/download/index.vue'),
              name: 'download',
