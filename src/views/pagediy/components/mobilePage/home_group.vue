    ...
    <div class="group" :style="boxStyle">
              ...
              <div class="right-top">
                ...
                <div class="pink acea-row" v-if="typeShow.includes(1)">
                  <div class="people-box acea-row" :style="groupTitleColor">
                    ...
                    <div class="groupNum" :style="groupTitleFontColor">已拼156份</div>
                  </div>
                </div>
              </div>
      ...
      <div class="group-bottom four acea-row" v-if="listStyle == 3" :style="boxBgStyle">
        <div v-for="(item, index) in 6" :key="index" class="four-item">
          ...
          <div class="two-item">
            <div class="title acea-row" v-if="typeShow.includes(0)" :style="nameColor">
              <div :style="groupTitleColor" class="numPink-box numPink-box-special">
                <div class="numPink" v-if="typeShow.includes(1)" :style="groupTitleFontColor">5人团</div>
              </div>
              <span class="line1"
...
export default {
  ...
  computed: {
    ...
    groupTitleColor() {
      return {
        backgroundColor: this.configObj.groupTitleColor.color[0].item,
      };
    },
    //已拼颜色
    groupTitleFontColor() {
      return [
        {
          color: this.configObj.groupTitleColor.color[0].item,
        },
      ];
    },
    //按钮颜色
    btnColor() {
      return [
        {
          background: `linear-gradient(to right,${this.configObj.btnColor.color[0].item}, ${this.configObj.btnColor.color[1].item})`,
        },
        {
