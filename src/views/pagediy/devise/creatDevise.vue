      ...
      <div class="diy-wrapper" :style="'height:' + (clientHeight + 9) + 'px;'">
        ...
        <div class="wrapper-con">
          <div class="content">
            ...
            >
              <div :class="activeIndex === -100 ? 'border' : ''">
                <div class="overflowy">
                  ...
                  <div style="margin: 0 auto; position: relative; height: auto">
                    ...
                    >
                      ...
                      >
                        <div
                          :style="
                            item.name === 'home_footer' ? ' position: fixed; z-index: 1;width: 378px;bottom:0' : ''
                          "
                          ref="mConfigItem"
                          class="mConfig-item"
                          :class="{
  ...
  methods: {
    ...
    addDomCon(item, type, index) {
      ...
      this.$nextTick(() => {
        ...
        let offsetHeight = this.$refs.mConfigItem.offsetHeight;
